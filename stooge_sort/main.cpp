...
void stooge_sort_base(std::vector<int>& vec, const unsigned int j, const unsigned int i = 0)
{
...
int main()
{
	std::vector<int> mints{ 98, 75, 68, 18, 40, 73, 28, 61, 98, 52, 7, 92, 5, 8, 60, 97, 66, 38, 53, 28, 97, 53, 91, 18, 85 };
